...
public class Attendence {
	...
	public String toString() {
		return "Attendence [id=" + id + ", selectclass=" + selectclass + ", selectsection=" + selectsection
				...
				+ ", getId()=" + getId() + ", getSelectclass()=" + getSelectclass() + ", getSelectsection()="
				+ getSelectsection() + ", getSelectmonth()=" + getSelectmonth() + ", getStudentname()="
				+ getStudentname() + ", getSelectsession()=" + getSelectsession() + ", isOne()=" + isOne()
				+ ", isTwo()=" + isTwo() + ", isThree()=" + isThree() + ", isFour()=" + isFour() + ", isFive()="
				+ isFive() + ", isSix()=" + isSix() + ", isSeven()=" + isSeven() + ", isEight()=" + isEight()
				+ ", isNine()=" + isNine() + ", isTen()=" + isTen() + ", isEleven()=" + isEleven() + ", isTwelve()="
				+ isTwelve() + ", isThirteen()=" + isThirteen() + ", isFourteen()=" + isFourteen() + ", isFifteen()="
				+ isFifteen() + ", isSixteen()=" + isSixteen() + ", isSeventeen()=" + isSeventeen() + ", isEighteen()="
				+ isEighteen() + ", isNineteen()=" + isNineteen() + ", isTwenty()=" + isTwenty() + ", isTwentyone()="
				+ isTwentyone() + ", isTwentytwo()=" + isTwentytwo() + ", isTwentythree()=" + isTwentythree()
				+ ", isTwentyfour()=" + isTwentyfour() + ", isTwentyfive()=" + isTwentyfive() + ", isTwentysix()="
				+ isTwentysix() + ", isTwentyseven()=" + isTwentyseven() + ", isTwentyeight()=" + isTwentyeight()
				+ ", isTwentynine()=" + isTwentynine() + ", isThirty()=" + isThirty() + ", isThirtyone()="
				+ isThirtyone() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode() + ", toString()="
				+ super.toString() + "]";
	}
